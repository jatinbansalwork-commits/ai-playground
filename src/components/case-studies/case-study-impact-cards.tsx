...
export function CaseStudyImpactCards({
  ...
  return (
    <div
      className={`mx-auto w-full max-w-5xl overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-50 ${className}`.trim()}
    ...
    >
      {items.map((item, index) => (
        ...
        >
          <span
            className="pt-0.5 font-mono text-2xl font-medium tabular-nums leading-none text-sky-700 md:text-3xl"
            aria-hidden
          >
