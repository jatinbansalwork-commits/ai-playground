 ...
 * so glyph bounds stay identical when toggling outline rendering.
 */
...
export const INDEX_SLIDE_LABEL = `${INDEX_SLIDE_TYPE} font-normal tracking-tight leading-none text-sm text-neutral-500`;
