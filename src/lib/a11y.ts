...
export const NAV_BACK_LINK_CLASS =
  `nav-back-link ${SITE_BACK_TYPEFACE} pointer-events-auto fixed top-8 left-8 z-[100] inline-flex min-h-11 items-center gap-2 pr-3 text-sm text-neutral-400 transition-colors hover:text-white touch-manipulation ${FOCUS_RING}`;
